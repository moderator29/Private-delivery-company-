...
- Name: tracking.spec.ts >> tracking a valid shipment >> summarises the package and the delivery estimate
- Location: tests/e2e/tracking.spec.ts:41:7
...
Locator: getByText('Standard Delivery')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Standard Delivery')
