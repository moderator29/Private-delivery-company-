...
- Name: tracking-form.spec.ts >> the tracking form on the home page >> accepts the spaced form a customer copies from an email
- Location: tests/e2e/tracking-form.spec.ts:16:7
