...
- Name: tracking-form.spec.ts >> the tracking form on the home page >> shows an inline error for junk and stays on the page
- Location: tests/e2e/tracking-form.spec.ts:25:7
