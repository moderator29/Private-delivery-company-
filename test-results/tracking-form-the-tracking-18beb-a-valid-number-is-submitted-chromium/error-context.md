...
- Name: tracking-form.spec.ts >> the tracking form on the home page >> navigates to the shipment when a valid number is submitted
- Location: tests/e2e/tracking-form.spec.ts:6:7
